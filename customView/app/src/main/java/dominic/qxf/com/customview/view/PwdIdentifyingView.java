...
public class PwdIdentifyingView extends android.support.v7.widget.AppCompatEditText {
    ...
    public PwdIdentifyingView(Context context) {
        super(context);
        setAttr(null, 0);
        init();
    }

    public PwdIdentifyingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttr(attrs, 0);
        init();
    }

    public PwdIdentifyingView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setAttr(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.PwdIdentifyingView, defStyleAttr, 0);
        isPwd = a.getBoolean(R.styleable.PwdIdentifyingView_isPwd, true);
        isAutoCloseKeyBoard = a.getBoolean(R.styleable.PwdIdentifyingView_autoCloseKeyBoard, true);
        widthSpace = a.getDimensionPixelSize(R.styleable.PwdIdentifyingView_widthSpace, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, getResources().getDisplayMetrics()));
        pwdType_CircleRadius = a.getDimensionPixelSize(R.styleable.PwdIdentifyingView_circleRadius, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, getResources().getDisplayMetrics()));
        heightSpace = a.getDimensionPixelSize(R.styleable.PwdIdentifyingView_heightSpace, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, getResources().getDisplayMetrics()));
        rectStroke = a.getDimensionPixelSize(R.styleable.PwdIdentifyingView_rectStroke, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getResources().getDisplayMetrics()));
        txtSize = a.getDimensionPixelSize(R.styleable.PwdIdentifyingView_txtSize, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 18, getResources().getDisplayMetrics()));
        isBgFill = a.getBoolean(R.styleable.PwdIdentifyingView_bgFill, false);
        numLength = a.getInt(R.styleable.PwdIdentifyingView_numLength, 6);
        textColor = a.getColor(R.styleable.PwdIdentifyingView_textColor, 0xff666666);
        isCorner = a.getBoolean(R.styleable.PwdIdentifyingView_isCorner, true);
        isNeedDash = a.getBoolean(R.styleable.PwdIdentifyingView_isNeedDash, true);
        //圆角边框颜色
        broderColor = a.getColor(R.styleable.PwdIdentifyingView_broderColor, 0xff666666);
        //圆角边框厚度
        broderWidt = a.getDimensionPixelSize(R.styleable.PwdIdentifyingView_broderWidth, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1, getResources().getDisplayMetrics()));
        //虚线颜色
        dottedColor = a.getColor(R.styleable.PwdIdentifyingView_dottedColor, 0xff666666);
        rectNormalColor = a.getColor(R.styleable.PwdIdentifyingView_rectNormalColor, 0xff808080);
        rectChooseColor = a.getColor(R.styleable.PwdIdentifyingView_rectChooseColor, 0xff44ce61);
        pwdType = a.getInt(R.styleable.PwdIdentifyingView_pwdType, 0) == 0 ? PwdType.CIRCLE : PwdType.XINGHAO;
        a.recycle();
    }
