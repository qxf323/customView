...
public class PassWordView extends RelativeLayout {
    ...
    private CustomKeyBoardView customerKeyboardView;
    ...
    public PassWordView(Context context, AttributeSet attrs) {
        ...
        customerKeyboardView = (CustomKeyBoardView) view.findViewById(R.id.virtualKeyboardView);
        imgCancel = (ImageView) view.findViewById(R.id.img_cancel);
        gridView = customerKeyboardView.getGridView();
    ...
    private void setupView() {
        ...
        CustomerKeyBoardAdapter keyBoardAdapter = new CustomerKeyBoardAdapter(mContext, valueList);
    ...
    //设置监听方法，在第6位输入完成后触发
    public void setOnFinishInput(final OnPasswWordInputFinish pass) {
    ...
    public CustomKeyBoardView getVirtualKeyboardView() {

        return customerKeyboardView;
    }
